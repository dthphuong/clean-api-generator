                            ...
                            async.series([
                                ...
                                (callback) => {
                                    ...
                                    _.each(collections, (colName) => {
                                        ...
                                        routeIndex += "\tapp.get('/" + colName + "', Middleware.authorized, " + utils.String.toProperCase(colName) + ".getAll);\n";
                                        routeIndex += "\tapp.get('/" + colName.slice(0, -1) + "', Middleware.authorized, " + utils.String.toProperCase(colName) + ".getById);\n";
                                        routeIndex += "\tapp.post('/" + colName.slice(0, -1) + "', Middleware.authorized, " + utils.String.toProperCase(colName) + ".create);\n";
                                        routeIndex += "\tapp.put('/" + colName.slice(0, -1) + "', Middleware.authorized, " + utils.String.toProperCase(colName) + ".update);\n";
                                        routeIndex += "\tapp.delete('/" + colName.slice(0, -1) + "', Middleware.authorized, " + utils.String.toProperCase(colName) + ".delete);\n";
                                    })
                                    routeIndex += "}"
